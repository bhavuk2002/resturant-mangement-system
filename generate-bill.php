...
<body>
    <div class="main-content">
            ...
            <table width = 35%>
                ...
                <td>
                    <select>
                        ...
                        ?>
                        <option id="<?php echo $row['id']; ?>" value="<?php $title = $row['title']; $id=$row['id'];?>" >
                            <?php echo $title; ?>
                        </option>
                        <?php  }?>
                ...
                <td>
                    <?php
                    $sql2 = "SELECT price FROM menu where id=$id";
        ...
        <br><br>
        <div class="col-md-15	mt-30" style="background-color:#f5f5f5;">
